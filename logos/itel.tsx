export default function ItelIcon({
  ...
  return (
    ...
    >
      ...
      <path d="M31.8 21.2C34.5 21.2 36.7 19.9 37.7 17.5H34.4C33.8 18.3 33.1 18.7 32 18.7C30.6 18.7 29.5 17.7 29.4 16.4H38C39.3 12.4 37.2 9.29999 33 9.29999C29.6 9.29999 27.2 11.2 26.6 14.4C25.9 18.3 28.1 21.2 31.8 21.2ZM33 11.8C34.5 11.8 35.4 12.7 35.4 14H29.9C30.2 12.8 31.4 11.8 33 11.8Z" fill="white"/>
      <path d="M24 21.2H24.8L25.4 18.3H24.7C23.6 18.3 23.1 17.5 23.3 16.3L24.1 12.1H26.6L27.2 9.20002H24.7L25.2 6.40002H22L20.1 16.2C19.6 19.1 20.8 21.2 24 21.2Z" fill="white"/>
      <path d="M43.1 21.2H44L44.6 18.3H43.9C42.8 18.3 42.2 17.5 42.5 16.3L44.4 6.40002H41.2L39.3 16.2C38.7 19.3 40.1 21.2 43.1 21.2Z" fill="white"/>
